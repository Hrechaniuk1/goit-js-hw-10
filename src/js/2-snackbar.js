...
function doSubmit(event) {
    ...
    message: `✅ Fulfilled promise in ${value}ms`,
        backgroundColor: "rgb(89, 161, 13)", closeOnEscape: true, position: "topRight",
    messageColor: "white",
})).catch(value => iziToast.show({
    message: `❌ Rejected promise in ${delayValue}ms`,
    backgroundColor: "rgb(239, 64, 64)", closeOnEscape: true, position: "topRight", messageColor: "white",
}))
